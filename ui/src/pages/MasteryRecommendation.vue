    ...
    >
      <n-space vertical>
        ...
        <div>
          ...
          <help-text>
            九色鹿保留为非 T5 材料的因果垫刀推荐；自动填写需要已拥有并解锁因果技能。
            选择九色鹿时会自动添加碳素、碳素组、家具零件_碳素组作为垫刀材料。
          </help-text>
          <n-tag
            v-if="workshopDefaults?.nine_colored_deer && !workshopDefaults.nine_colored_deer.owned"
            size="small"
