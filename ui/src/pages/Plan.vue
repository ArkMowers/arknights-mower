  ...
  >
    ...
    <n-form-item>
      <template #label>
        ...
        <help-text>
          <p>
            测试设置：对符合条件的主班生效，休息优先级低于「宿舍低优先级干员」。
            有床则休息；无床时，绑组候补随组待命并随组回班，未绑组候补随下一批宿舍干员回班。低于急救线后，本轮升级为低优直到回班。
          </p>
          <p>
            无床待命需要已有能入住宿舍休息的高优干员提供回班时机；否则仍须取得床位。
            用尽、回满、宿舍固定干员不转为候补；零心情工作干员绑组后随组上下班，但不入住宿舍。
          </p>
        </help-text>
      </template>
