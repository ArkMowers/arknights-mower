...
Res = Literal[
    ...
    "factory_collect",
    "factory_furniture",
    "factory_product_cancel_confirm",
    "factory_product_change_confirm",
    "factory_product_select",
    "friend_list",
    "friend_visit",
    "hypergryph",
    "index_nav",
    ...
    "reclamation/reclamation_main",
    "reclamation/reclamation_tales",
    "reclamation/reclamation_anchor",
    "reclamation/anchor_start",
    "reclamation/reclamation_anchor_main",
    "reclamation/anchor_base",
    "reclamation/anchor_startup",
    "reclamation/anchor_unlock",
    "riic/assistants",
    "riic/exp",
    "riic/iron",
    "riic/manufacture",
