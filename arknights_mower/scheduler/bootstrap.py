...
def _build_planners(state: SchedulerState) -> list:
    ...
    if conf.recruit_enable:
        from arknights_mower.scheduler.planners.recruit import RecruitPlanner

        planners.append(RecruitPlanner())

    if conf.skland_enable:
        from arknights_mower.scheduler.planners.skland import SklandPlanner

        planners.append(SklandPlanner())

    if conf.check_mail_enable:
        from arknights_mower.scheduler.planners.mail import MailPlanner

        planners.append(MailPlanner())

    if conf.maa_depot_enable:
        from arknights_mower.scheduler.planners.depot import DepotPlanner

        planners.append(DepotPlanner())
