...
class Arknights数据处理器:
    ...
    def 获得干员基建描述(self):
        ...
        # gamedata 的 building_data.json 暂缺部分干员基建技能数据，手动补齐
        for 干员 in [
            {
                "key": 421,
                "name": "机械师",
                ...
                "child_skill": [
                    ...
                    },
                    {
                        ...
                        "buffer": False,
                        "buffer_des": [],
                        "des": "进驻制造站时，若单次工作时长达到<@cc.vup>12</>小时，生产力<@cc.vup>+10%</>",
                        "roomType": "制造站",
                        "buffCategory": "OUTPUT",
                        "skillIcon": "bskill_man_spd_mechanist",
                        "buffColor": "#ffd800",
                        "textColor": "#333333",
                    },
                ],
            },
            {
                ...
                "child_skill": [
                    ...
                    },
                    {
                        ...
                        "buffer": False,
                        "buffer_des": [],
                        "des": "进驻训练室协助位时，<@cc.kw>辅助</>干员的专精技能训练速度<@cc.vup>+30%</>，如果训练位干员分支为<@cc.kw>游击手</>，则训练速度额外<@cc.vup>+45%</>",
                        "roomType": "训练室",
                        "buffCategory": "FUNCTION",
                        "skillIcon": "bskill_train_supportiveranger",
                        "buffColor": "#7d0022",
                        "textColor": "#ffffff",
                    },
                ],
